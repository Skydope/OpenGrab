...
def test_finalize_desktop_moves_file(client, app_state, monkeypatch):
    """IS_DESKTOP=true: finalize_desktop mueve archivo a library_dir."""
    import config
    import tempfile
    ...
    app_state.library.finalize_desktop("finalize-test", workdir, video_file, info, "best")
...
def test_finalize_desktop_empty_library_dir_falls_back_to_out_dir(
    ...
    app_state.library.finalize_desktop("finalize-fallback", workdir, video_file, info, "best")
...
def test_finalize_desktop_playlist_subdir(client, app_state, monkeypatch):
    ...
    app_state.library.finalize_desktop(
...
def test_finalize_desktop_nested_name_template_creates_parents(client, app_state, monkeypatch):
    ...
    app_state.library.finalize_desktop("finalize-nested", workdir, video_file, info, "best")
